...
public class LibraryItemUpSessionFileAPIController extends AbstractVMwareController
    ...
    public LibraryItemUpSessionFileAPIController(@Qualifier("library-item-up-session-file-api-service")
    ...
    public RestResult<FileTypes.Info> add(String vmwareId, String sessionId, UpSessionFileCreate upSessionFileCreate) {
        return RestResult.success(
            addLibraryItemFile(libraryItemUpSessionFileService, vmwareId, sessionId, upSessionFileCreate));
    }
