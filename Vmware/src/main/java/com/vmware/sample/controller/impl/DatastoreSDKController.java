...
public class DatastoreSDKController implements DatastoreController {
    private final DatastoreService datastoreService;

    public DatastoreSDKController(@Qualifier("datastore-sdk-service") DatastoreService datastoreService) {
