...
public class LibraryItemSDKController implements LibraryItemController {
    private final LibraryItemService libraryItemService;

    public LibraryItemSDKController(@Qualifier("library-item-sdk-service") LibraryItemService libraryItemService) {
