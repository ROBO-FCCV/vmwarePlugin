...
public class DataCenterSDKController implements DataCenterController {
    private final DataCenterService dataCenterService;

    public DataCenterSDKController(@Qualifier("datacenter-sdk-service") DataCenterService dataCenterService) {
