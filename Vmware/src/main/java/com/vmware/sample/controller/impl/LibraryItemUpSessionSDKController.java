...
/**
 * Library item up session sdk controller
 *
 * @since 2020-10-15
 */
@Slf4j
...
public class LibraryItemUpSessionSDKController implements LibraryItemUpSessionController {
    private final LibraryItemUpSessionService libraryItemUpSessionService;

    public LibraryItemUpSessionSDKController(
        @Qualifier("library-item-up-session-sdk-service") LibraryItemUpSessionService libraryItemUpSessionService) {
