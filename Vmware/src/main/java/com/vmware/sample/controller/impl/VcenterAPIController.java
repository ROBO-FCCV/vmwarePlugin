...
public class VcenterAPIController implements VcenterController {
    private final VcenterService vcenterService;

    public VcenterAPIController(@Qualifier("vcenter-api-service") VcenterService vcenterService) {
